...
namespace Demo.Evolutionary
{
    public class MyAlgorithmRunner2 : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            StandardIndividual2[] endPopulation =
                algorithm.RunForGenerations(generations).Cast<StandardIndividual2>().ToArray();

            DrawRepresentation(endPopulation.First());
        }

        private void DrawRepresentation(StandardIndividual2 individual)
        {
